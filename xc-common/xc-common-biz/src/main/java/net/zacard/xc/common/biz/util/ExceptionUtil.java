...
import net.zacard.xc.common.biz.infra.exception.UncheckedException;
...
public class ExceptionUtil {
    ...
    public static BusinessException uncheckedWithBiz(Throwable throwable) {
    ...
    public static BusinessException uncheckedWithBiz(String message, Throwable throwable) {
